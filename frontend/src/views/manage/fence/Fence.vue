...
import BulletinAdd from './FenceAdd.vue'
import BulletinEdit from './FenceEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/attendance-geo-fence/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/attendance-geo-fence/page', {
        ...params
      }).then((r) => {
