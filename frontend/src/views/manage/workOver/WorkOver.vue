          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                <a-input v-model="queryParams.policyName"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
...
import BulletinAdd from './WorkOverAdd.vue'
import BulletinEdit from './WorkOverEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/attendance-policy/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/attendance-policy/overPage', {
        ...params
      }).then((r) => {
