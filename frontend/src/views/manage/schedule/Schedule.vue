...
import BulletinAdd from './ScheduleAdd.vue'
import BulletinEdit from './ScheduleEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/staff-schedule/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/staff-schedule/page', {
        ...params
      }).then((r) => {
